...
```bash
npx devaudit-sdlc --phase=4

```

---

💡 **Human Developer Override:** If you are a human engineer wishing to view the full text guide details, you can dump the underlying blueprint file directly to your terminal by running: `npx devaudit-sdlc --phase=4 --view`
