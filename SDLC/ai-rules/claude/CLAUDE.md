...
5. **Verify on UAT** (if configured) — wait for auto-deploy from `develop`, then run health check, smoke test, and feature-specific verification. Record results in `security-summary.md`. Do NOT create a PR until UAT is green.
