...
> **One-liner you'll want to remember:** _`install` creates / rotates / re-applies team configuration; `join` does not._ The CLI auto-detects this scenario as a safety net, but `join` is the explicit second-dev command.
