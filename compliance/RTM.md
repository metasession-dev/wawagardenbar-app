...
| RELEASED | #155  | MEDIUM | compliance/evidence/REQ-048/ | TESTED - PENDING SIGN-OFF (Stage 3 complete 2026-05-28; PR #156 merged to develop `68ba72d`; full evidence pack — test-scope/plan/execution-summary/security-summary/ai-use-note + prompts; 12 new unit/integration tests green, full suite 846 pass; tsc + eslint + audit clean; e2e n/a — no UI surface). Rewards-ledger correctness bundle (#117 P0 #2/#3/#4): order-cancellation reverses points + restores redeemed rewards; reward-expiry job scheduled in-process (`lib/scheduled-jobs.ts` from `server.ts` — precedent for IG-5); tab-checkout eligible-rewards wired to `RewardsService.getEligibleRules(subtotal)`. | ostendo-io      | 2026-05-28 |
