# DRAFT — GitHub issue body (replaces #53)

**Title:** `feat: end-to-end multi-inventory deduction for menu items with customization options`

**Labels:** `feature`, `inventory`, `order-flow`, `risk:high`
