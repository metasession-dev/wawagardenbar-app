...
## UAT Verification — 2026-03-27 (Bug Fix)

- Partial payments now appear in daily report on the day they are made (verified: Cash ₦1,800 from 6 partial payments on open tabs)
- Fix: UI condition changed to show payment breakdown when paymentBreakdown.total > 0 (previously required orderCount > 0)
