...
| AC  | Statement                                                                                                                  | Test                                                                                                                                                                                                                  |
| --- | -------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AC1 | `paymentMethod` is required on every Order create / mutation path                                                          | `__tests__/tabs/partial-payment-validation.test.ts` — paymentType validation on tab partial-payment write path. Live coverage via `e2e/daily-report-payments.spec.ts` order/tab creation flows.                       |
