...
| --- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D1  | CI Upload Evidence                                | META-COMPLY HTTP 429 rate limit on bulk infra artefact upload. Reproducible across runs `25497311795` (REQ-035 `0ad8edf`), `25509934777` (REQ-036 `adb96cc`), `25542543761` (REQ-036 D2 `4aec084`); each fails 6–10 evidence files in. Workflow's `scripts/upload-evidence.sh` has no retry-with-backoff; portal-side limiter caps the bulk upload mid-stream. | Filed [META-COMPLY #263](https://github.com/metasession-dev/META-COMPLY/issues/263) for the infra fix (retry-with-backoff in the upload script template + optional bulk-upload endpoint). Quality Gates job remains green throughout — code is correct; only the portal mirror is incomplete. Reviewers can read evidence directly from the consumer repo at `compliance/evidence/REQ-036/`. |
