...
- [ ] AC3: Given main and sub-category are selected, when item results render/search runs, then only available sellable items matching both selections appear.
...
- [ ] AC6: Given a super-admin opens menu management, when filters render, then main categories precede sub-categories and the table filters by both selections.
...
- [ ] AC8: Given admin opens sellable inventory, when filters render, then main categories precede sub-categories and linked inventory rows filter by both selections.
