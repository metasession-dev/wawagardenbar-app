...
| AC3 | `__tests__/services/profitability-analytics-service.test.ts`, profitability action/API, and dashboard category filter | Unit/integration/E2E | Test execution summary and named E2E screenshots                      |
