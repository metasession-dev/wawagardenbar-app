...
| Unit — full suite            | PASS           | 1,494 passed, 4 skipped (170 files) — `npx vitest run`                                                                                                                                                           |
...
| E2E — REQ-108 targeted       | PASS           | 1/1, local run against a local disposable Mongo container (`e2e-test-engineer`, prior session)                                                                                                                   |
...
| Semgrep                      | DEFERRED TO CI | Not installed in this local environment; runs as part of the project's CI quality gates on push to `develop`                                                                                                     |
