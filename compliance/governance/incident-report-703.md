---
title: "[REGRESSION] critical/express-order-report.spec.ts :: critical/express-order-report.spec.ts › Express standalone order — POS payment › daily report reflects POS payment"
incident_id: "INC-20260906-703"
incident_kind: "incident"
source_release: "REPLACE — owning REQ-XXX or vYYYY.MM.DD.N"
source_issue: "703"
source_issue_url: "https://github.com/metasession-dev/wawagardenbar-app/issues/703"
semantic_id: "INC-20260906-703"
severity: "REPLACE — low | medium | high | critical"
detected_at: "2026-09-06T12:07:29Z"
resolved_at: "2026-09-26T16:50:58Z"
...
# Incident Report — [REGRESSION] critical/express-order-report.spec.ts :: critical/express-order-report.spec.ts › Express standalone order — POS payment › daily report reflects POS payment
...
**Source:** [#703](https://github.com/metasession-dev/wawagardenbar-app/issues/703)  
**Detected:** 2026-09-06T12:07:29Z  
**Closed:** 2026-09-26T16:50:58Z  
...
## 2. Narrative (from the GitHub issue)
    ...
    **Spec file:** critical/express-order-report.spec.ts
    **Test name:** critical/express-order-report.spec.ts › Express standalone order — POS payment › daily report reflects POS payment
    **Final status:** failed
    **Error message:**
    ```
    ...
    **testExecutionId:** 34027821547
    **Workflow run:** https://github.com/metasession-dev/wawagardenbar-app/actions/runs/34027821547
    **Git SHA:** cbbf1e0791db615e5f56ae5dc99ce527050d01cb
...
### 2026-09-26T16:50:58Z — @metasession-dev

Stale — express-order-report.spec.ts passes in full (27/27) in the latest full regression run (35863443829, 2026-09-23). Closing as no longer reproducing.
