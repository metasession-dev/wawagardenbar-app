---
title: "[REGRESSION] kitchen/inventory-crud.spec.ts :: kitchen/inventory-crud.spec.ts › REQ-037 — Edit + archive + restore kitchen ingredients (20 tests, all ACs) › AC7 — Restore brings the row back to active list AND back into Recipe builder dropdown"
incident_id: "INC-20260908-723"
incident_kind: "incident"
source_release: "REQ-037"
source_issue: "723"
source_issue_url: "https://github.com/metasession-dev/wawagardenbar-app/issues/723"
semantic_id: "INC-20260908-723"
severity: "REPLACE — low | medium | high | critical"
detected_at: "2026-09-08T05:41:31Z"
resolved_at: "2026-09-08T12:52:38Z"
...
# Incident Report — [REGRESSION] kitchen/inventory-crud.spec.ts :: kitchen/inventory-crud.spec.ts › REQ-037 — Edit + archive + restore kitchen ingredients (20 tests, all ACs) › AC7 — Restore brings the row back to active list AND back into Recipe builder dropdown
...
**Source:** [#723](https://github.com/metasession-dev/wawagardenbar-app/issues/723)  
**Detected:** 2026-09-08T05:41:31Z  
**Closed:** 2026-09-08T12:52:38Z  
...
## 2. Narrative (from the GitHub issue)
    ...
    **Spec file:** kitchen/inventory-crud.spec.ts
    **Test name:** kitchen/inventory-crud.spec.ts › REQ-037 — Edit + archive + restore kitchen ingredients (20 tests, all ACs) › AC7 — Restore brings the row back to active list AND back into Recipe builder dropdown
    **Final status:** failed
    **Error message:**
    ```
...
### 2026-09-08T12:52:37Z — @metasession-dev
