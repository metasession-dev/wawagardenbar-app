---
title: "[REGRESSION] requirements-verification.spec.ts :: requirements-verification.spec.ts › Section 24: Data Management & Privacy › data deletion page is publicly accessible"
incident_id: "INC-20260909-754"
incident_kind: "incident"
source_release: "REPLACE — owning REQ-XXX or vYYYY.MM.DD.N"
source_issue: "754"
source_issue_url: "https://github.com/metasession-dev/wawagardenbar-app/issues/754"
semantic_id: "INC-20260909-754"
severity: "REPLACE — low | medium | high | critical"
detected_at: "2026-09-09T13:58:37Z"
resolved_at: "2026-09-26T16:49:49Z"
...
# Incident Report — [REGRESSION] requirements-verification.spec.ts :: requirements-verification.spec.ts › Section 24: Data Management & Privacy › data deletion page is publicly accessible
...
**Source:** [#754](https://github.com/metasession-dev/wawagardenbar-app/issues/754)  
**Detected:** 2026-09-09T13:58:37Z  
**Closed:** 2026-09-26T16:49:49Z  
...
## 2. Narrative (from the GitHub issue)
    ...
    **Test name:** requirements-verification.spec.ts › Section 24: Data Management & Privacy › data deletion page is publicly accessible
...
### 2026-09-09T14:42:25Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/34353226258 (SHA c99fa3c784977d2e7e01bca658903336556789c3). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-15T06:07:15Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/34933824608 (SHA e22d8fc7cd4520fe0936fb7aac50855788a546d3). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-15T07:07:52Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/34937252563 (SHA 99ae24844a90b382130303981396621459295a34). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-16T18:01:05Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/35125721991 (SHA a199d05e5bf57662ba5c1857f284f357dfeb8edf). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-17T06:01:37Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/35125721991 (SHA a199d05e5bf57662ba5c1857f284f357dfeb8edf). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-17T06:40:42Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/35189228775 (SHA d330adec112c8dab5e009a947d9e848591652df4). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-26T16:49:48Z — @metasession-dev
