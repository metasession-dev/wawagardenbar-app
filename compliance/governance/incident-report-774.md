---
title: "[REGRESSION] requirements-verification.spec.ts :: requirements-verification.spec.ts › Section 20: Public REST API › GET /api/public/tabs/summary rejects unauthenticated requests (scope: tabs:read)"
incident_id: "INC-20260914-774"
incident_kind: "incident"
source_release: "REPLACE — owning REQ-XXX or vYYYY.MM.DD.N"
source_issue: "774"
source_issue_url: "https://github.com/metasession-dev/wawagardenbar-app/issues/774"
semantic_id: "INC-20260914-774"
severity: "REPLACE — low | medium | high | critical"
detected_at: "2026-09-14T21:05:18Z"
resolved_at: "2026-09-26T16:50:31Z"
...
# Incident Report — [REGRESSION] requirements-verification.spec.ts :: requirements-verification.spec.ts › Section 20: Public REST API › GET /api/public/tabs/summary rejects unauthenticated requests (scope: tabs:read)
...
**Source:** [#774](https://github.com/metasession-dev/wawagardenbar-app/issues/774)  
**Detected:** 2026-09-14T21:05:18Z  
**Closed:** 2026-09-26T16:50:31Z  
...
## 2. Narrative (from the GitHub issue)
    ...
    **Test name:** requirements-verification.spec.ts › Section 20: Public REST API › GET /api/public/tabs/summary rejects unauthenticated requests (scope: tabs:read)
    ...
    **testExecutionId:** 34894313779
    **Workflow run:** https://github.com/metasession-dev/wawagardenbar-app/actions/runs/34894313779
    **Git SHA:** 2f6a0dcbeb79c406061d3e975f3154c528a33326
...
### 2026-09-17T09:41:27Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/35202395399 (SHA 8131caae2e4a3247c391078ae2f88b0d67d0e376). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-22T21:48:32Z — @github-actions

Additional failure detected in workflow run https://github.com/metasession-dev/wawagardenbar-app/actions/runs/35788452665 (SHA 19f998d3a41f875545feab27bd2fe8f3a3635a2f). Spec: requirements-verification.spec.ts. Classification: application-defect. Rationale: Error is an assertion failure, application error, or unrecognised pattern. Defaulting to application defect (conservative).

### 2026-09-26T16:50:31Z — @metasession-dev
