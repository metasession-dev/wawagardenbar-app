...
- **Core tracked release:** `REQ-104` (declared bundle key; co-tracked with REQ-105, REQ-106, REQ-107)
- **Bundle manifest:** `BUNDLED-CHANGES-REQ-104.json`
- **Manifest hash:** `sha256:e84a35121bd6a67702a783a8fdfbbcc773fe716f0865a89d70498cc4b257df43`
- **Absorbed predecessor releases:** None
- **Co-tracked bundle members:** REQ-104 REQ-105 REQ-106 REQ-107
- **Absorbed non-release work:** housekeeping commits since `main`
- **Why bundled here:** REQ-104, REQ-105, and REQ-106 were declared as an explicit bundle at Phase 1 planning time (`Bundles: #767, #768, #769`) — all three are LOW/MEDIUM risk, share one branch/PR/release cycle, and touch distinct file sets with no scope overlap between them. REQ-107 was added as a bundle addendum mid-cycle (a LOW-risk, unrelated-file defect discovered during the same UAT review) rather than a new branch/PR/release cycle, per the operator's explicit direction.
...
- **Reviewer impact:** Approval scope covers all four co-tracked REQs plus the absorbed non-release housekeeping work listed below.
...
- `REQ-107` (co-tracked/bundled, added mid-cycle) — Expense summary totals follow list filters
