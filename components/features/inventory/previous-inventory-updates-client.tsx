...
export function PreviousInventoryUpdatesClient() {
  ...
  useEffect(() => {
    loadSnapshots();
  }, [statusFilter, categoryFilter, dateRange, page]);
  ...
  async function loadSnapshots() {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        toast({
          title: 'Error',
          description: result.error || 'Failed to load inventory updates',
          variant: 'destructive',
        });
      }
    } catch (error) {
      ...
      toast({
        title: 'Error',
        description: 'Failed to load inventory updates',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Filter Inventory Updates</CardTitle>
